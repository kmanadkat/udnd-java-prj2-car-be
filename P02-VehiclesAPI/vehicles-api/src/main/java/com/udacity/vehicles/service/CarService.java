...
public class CarService {
    ...
    public Car findById(Long id) {
         ...
         */
        String foundCarPrice = this.priceClient.getPrice(id);
        foundCar.setPrice(foundCarPrice);
         ...
         */
        Location locationWithAddress = this.mapsClient.getAddress(foundCar.getLocation());
        foundCar.getLocation().setAddress(locationWithAddress.getAddress());
