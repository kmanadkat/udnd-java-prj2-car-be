...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        ...
        mvc.perform(get("/cars"))
                ...
                .andExpect(jsonPath("$._embedded.carList[0].condition", is(testCar.getCondition().toString())));
    }
    ...
    public void findCar() throws Exception {
        ...
        mvc.perform(get("/cars/1"))
                ...
                .andExpect(jsonPath("$.details.fuelType", is(testCar.getDetails().getFuelType())));
    }
